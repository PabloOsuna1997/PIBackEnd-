...
CREATE TABLE USUARIO(
	...
	password INTEGER VARCHAR(20) NOT NULL,
...
CREATE TABLE TRANSFERENCIA(
	...
	estado_transferencia VARCHAR(!) NOT NULL,
...
CREATE TABLE VENTA(
	...
	CONSTRAINT PK_U_VENTA FOREIGN KEY (vendedor) REFERENCES USUARIO(correo),
	CONSTRAINT PK_C_VENTA FOREIGN KEY (cliente) REFERENCES CLIENTE(nit),
	CONSTRAINT PK_R_VENTA FOREIGN KEY (repartidor) REFERENCES USUARIO(correo)
);